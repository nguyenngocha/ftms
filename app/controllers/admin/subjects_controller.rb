class Admin::SubjectsController < ApplicationController
  ...
  def show
    ...
    add_breadcrumb @course.name, eval("#{@namespace}_course_path(@course)")
  ...
  def create
    ...
    if @subject.save
      ...
      redirect_to eval("#{@namespace}_subjects_path")
    else
  ...
  def edit
    add_breadcrumb_path "subjects"
    add_breadcrumb @subject.name, eval("#{@namespace}_subject_task_masters_path(@subject)")
  ...
  def update
    if @subject.update_attributes subject_params
      ...
      redirect_to eval("#{@namespace}_subject_task_masters_path(@subject)")
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html {redirect_to eval("#{@namespace}_subjects_path")}
    end
  end
